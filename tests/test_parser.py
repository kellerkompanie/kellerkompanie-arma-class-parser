...
class TestParser(unittest.TestCase):
    ...
    def test_identifier1(self):
        ...
        expected_token = Token(TokenType.STRING_LITERAL, lexer.STRING_INPUT_FILE, 1, 1, value="x")
    ...
    def test_identifier2(self):
        ...
        expected_token = Token(TokenType.STRING_LITERAL, lexer.STRING_INPUT_FILE, 1, 1, value="CfgPatches")
        identifier = Identifier(expected_token)
        self.assertEqual([identifier], ast)
    ...
    def test_identifier3(self):
        ...
        expected_token = Token(TokenType.STRING_LITERAL, lexer.STRING_INPUT_FILE, 1, 1, value="class0")
        identifier = Identifier(expected_token)
        self.assertEqual([identifier], ast)
    ...
    def test_assignment1(self):
        ...
        left_token = Token(TokenType.STRING_LITERAL, lexer.STRING_INPUT_FILE, 1, 1, value='a')
        equals_token = Token(TokenType.EQUALS, lexer.STRING_INPUT_FILE, 1, 3)
        right_token = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 5, value='1337')
    ...
    def test_assignment2(self):
        ...
        right_token = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 3, value='1337')
    ...
    def test_assignment3(self):
        ...
        right_tokens = [
            ...
            Token(TokenType.STRING_LITERAL, lexer.STRING_INPUT_FILE, 1, 6, value='Hello'),
    ...
    def test_assignment4(self):
        ...
        left_token = Token(TokenType.STRING_LITERAL, lexer.STRING_INPUT_FILE, 1, 1, value='author')
        ...
        right_tokens = [
            ...
            Token(TokenType.STRING_LITERAL, lexer.STRING_INPUT_FILE, 1, 11, value='Schwaggot'),
    ...
    def test_array_declaration1(self):
        ...
        name = Token(TokenType.STRING_LITERAL, lexer.STRING_INPUT_FILE, 1, 1, value='array')
    ...
    def test_array_simple1(self):
        ...
        l_curly_token = Token(TokenType.L_CURLY, lexer.STRING_INPUT_FILE, 1, 1)
        number_token = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 2, value='2')
    ...
    def test_array_simple2(self):
        ...
        l_curly_token = Token(TokenType.L_CURLY, lexer.STRING_INPUT_FILE, 1, 1)
        number_token = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 3, value='2')
    ...
    def test_array_simple3(self):
        ...
        l_curly_token = Token(TokenType.L_CURLY, lexer.STRING_INPUT_FILE, 1, 1)
        number_token1 = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 2, value='1')
        number_token2 = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 4, value='2')
        number_token3 = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 6, value='3')
    ...
    def test_array_simple4(self):
        ...
        l_curly_token = Token(TokenType.L_CURLY, lexer.STRING_INPUT_FILE, 1, 1)
        number_token1 = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 2, value='1')
        number_token2 = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 5, value='2')
        number_token3 = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 7, value='3')
    ...
    def test_array_mixed1(self):
        ...
        l_curly_token = Token(TokenType.L_CURLY, lexer.STRING_INPUT_FILE, 1, 1)
        number_token = Token(TokenType.NUMBER_LITERAL, lexer.STRING_INPUT_FILE, 1, 2, value='1')
        l_double_quotes_token = Token(TokenType.DOUBLE_QUOTES, lexer.STRING_INPUT_FILE, 1, 5)
        string_token = Token(TokenType.STRING_LITERAL, lexer.STRING_INPUT_FILE, 1, 6, value='hello')
